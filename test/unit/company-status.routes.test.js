...
const router = require('../../src/routes/admin-company.routes');
...
test('PATCH /admin/empresas/:id/status is mounted and restricted to admins', () => {
  assert.ok(app._router.stack.some((layer) => layer.regexp.test('/admin/empresas')));
