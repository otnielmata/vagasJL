...
[VJ-1](https://jl-mentoria.atlassian.net/browse/VJ-1) e o login da
[VJ-2](https://jl-mentoria.atlassian.net/browse/VJ-2).
...
- Status: `400` para JSON inválido e campos inválidos em `/usuarios` e `/login`, `401` para credenciais/token inválidos, `409` para
